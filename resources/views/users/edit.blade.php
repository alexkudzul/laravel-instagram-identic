            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', Auth::user())}}" enctype="multipart/form-data">
                        @csrf
                        {{-- le decimos a laravel que se quiere simular el method PUT --}}
                        {{method_field('PUT')}}

                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">{{ __('') }}</label>

                            <div class="col-md-6">
                                <img width="100px" src="{{Storage::url(Auth::user()->avatar)}}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nickname" type="text" class="form-control @error('nickname') is-invalid @enderror" name="nickname" value="{{ old('nickname', Auth::user()->nickname) }}" required autocomplete="nickname" autofocus>
